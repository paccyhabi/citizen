...
if(isset($_POST['recover-submit']))
{
    ...
    if($row)
    {
        ...
        $link = "<a href='http://localhost/mkul/reset-password.php?key=".$emailId."&token=".$token."'>Click To Reset password</a>";
    ...
    <p><a href="https://mk-library.cleverapps.io/reset-password.php?key=' . $emailId . '&token=' . $token . '">Click To Reset Password</a></p>
